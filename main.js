...
window.onload=function()
{
	if (!Game.ready)
	{
		var loadLangAndLaunch=function(lang,firstLaunch)
		{
			...
			LoadLang('https://cdn.jsdelivr.net/gh/rd-sa/cook@gh-pages/loc/EN.js?v='+Game.version,function(lang){return function(){
				locStringsFallback=locStrings;
				LoadLang('https://cdn.jsdelivr.net/gh/rd-sa/cook@gh-pages/loc/'+lang+'.js?v='+Game.version,function(){
					var launch=function(){
						Game.Launch();
